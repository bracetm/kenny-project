...
{
    if(GodMode[playerid]) RepairVehicle(vehicleid); SetVehicleHealth(vehicleid, 1000.0);
    return 1;
}
...
YCMD:aveh(playerid, const string:params[], help)
{
	...
	AdminVehicle[playerid] = CreateVehicle(VehicleModel, X, Y, Z, 0.0, 0, 0, -1);
